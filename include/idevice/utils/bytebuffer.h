#ifndef IDEVICE_UTILS_BYTE_BUFFER_H
...
#include "idevice/common/macro_def.h"  // IDEVICE_MEM_ALIGN, IDEVICE_DISALLOW_COPY_AND_ASSIGN
...
#endif  // IDEVICE_UTILS_BYTE_BUFFER_H
