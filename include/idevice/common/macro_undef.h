#ifdef IDEVICE_COMMON_MACRO_DEF_H  // make sure the "macro_def.h" file has been imported,
#undef IDEVICE_COMMON_MACRO_DEF_H  // and undo everything that was done in the "macro_def.h" file
