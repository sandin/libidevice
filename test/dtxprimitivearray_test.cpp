...
TEST(DTXPrimitiveArrayTest, Serialize2) {
  ...
  char* buffer = nullptr;
  size_t buffer_size = 0;
  nskeyedarchiver::NSKeyedArchiver::ArchivedData(kavalue, &buffer, &buffer_size, nskeyedarchiver::NSKeyedArchiver::OutputFormat::Binary);
  ...
  nskeyedarchiver::KAValue serialized_value2 = nskeyedarchiver::NSKeyedUnarchiver::UnarchiveTopLevelObjectWithData(bplist_ptr, bplist_size);
